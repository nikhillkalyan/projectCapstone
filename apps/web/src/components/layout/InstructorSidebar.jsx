...
import { BookOpen, Building, GraduationCap, LayoutDashboard, LogOut, MessageSquare, PlusCircle, UserCircle } from 'lucide-react';
    ...
    <aside className="glass-lg fixed left-0 top-0 flex h-screen w-64 flex-col border-r border-glass-border p-4">
      <div className="mb-8 flex items-center gap-3 px-2 pt-2">
        ...
        <div>
          ...
          <p className="text-xs font-semibold uppercase tracking-wide text-accent-400">Instructor Portal</p>
        </div>
      </div>
