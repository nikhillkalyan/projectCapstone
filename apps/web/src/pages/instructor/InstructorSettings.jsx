      ...
      <div className="max-w-4xl mx-auto w-full pb-24 space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-text-secondary mt-2 max-w-2xl">
                Update your public teaching profile, GitHub handle, and faculty identifier without the extra clutter.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-[28px] border border-border-subtle bg-bg-base/70 p-6 md:p-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Field label="GitHub Username" hint="Important for the upcoming project-space and GitHub integration work.">
