      ...
      <div className="relative flex h-full w-full overflow-hidden bg-transparent">
        ...
        <div className={`
          ...
          <div className="p-6 border-b border-border-subtle/50 pb-5">
            <h1 className="mb-1 font-display text-xl font-bold capitalize text-text-primary">Messages</h1>
              ...
              chatContacts.map((c, i) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center justify-start gap-4 rounded-lg border px-4 py-3.5 text-left transition-all ${isActive
                  ...
                  >
                    ...
                    <div className="flex-1 overflow-hidden">
                      <div className="flex items-center justify-between mb-0.5">
                        <h3 className={`truncate font-display text-sm font-bold ${isActive ? 'text-primary-300' : 'text-text-primary'} ${c.isRemoved ? 'text-error-400' : ''}`}>
                          {c.isRemoved ? '[Removed Account]' : c.userName}
                        </h3>
                      </div>
                      <p className="truncate pr-2 text-xs text-text-secondary">
                        {c.courseTitle}
                      </p>
                    </div>
                  </button>
        ...
        <div className={`
          ...
          {selectedChat && (
            <div className="md:hidden flex items-center px-4 py-3 bg-bg-surface border-b border-border-subtle">
              ...
              <span className={`ml-2 truncate font-display text-sm font-bold ${selectedChat.isRemoved ? 'text-error-400' : ''}`}>
