...
public class CourseServiceImpl implements CourseService {
        ...
        public List<CourseResponse> getAllCourses(String category, String level, String search) {
                List<Course> courses = courseRepository.findByIsUniversityCourseFalseOrIsUniversityCourseIsNull();
        ...
        public CourseResponse updateCourse(UUID courseId, UpdateCourseRequest request) {
                ...
                if (request.getPreviewVideo() != null)
        ...
        public List<CourseResponse> getCoursesByInstructor(UUID instructorId) {
                List<Course> courses = courseRepository.findByInstructorIdAndIsUniversityCourseFalse(instructorId);
                return courses.stream()
                                .map(this::mapToCourseResponse)
                                .collect(Collectors.toList());
        }
                ...
                return CourseResponse.builder()
                                ...
                                .instructor(instructorUser != null
                                                ? InstructorSummaryResponse.builder()
                                                                ...
                                                                .build()
                                                : null)
                                .grandAssessment(course.getGrandAssessment() != null
                                                ? mapToAssessmentResponse(course.getGrandAssessment())
                                                : null)
                                .build();
        }

        private AssessmentResponse mapToAssessmentResponse(Assessment assessment) {
                List<QuestionResponse> questions = (assessment.getQuestions() != null
                                ? assessment.getQuestions()
                                : Collections.<backend.backend.Entity.Question>emptyList()).stream()
                                ...
                                .map(q -> QuestionResponse.builder()
                                                ...
                                                .options((q.getOptions() != null
                                                                ? q.getOptions()
                                                                : Collections.<backend.backend.Entity.Option>emptyList())
                                                                .stream()
                                                                .filter(Objects::nonNull)
